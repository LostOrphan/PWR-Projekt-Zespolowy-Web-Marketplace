...
>
> 3. Instalacja wszystkich koniecznych bibliotek: `pip install -r requirements.txt`
>
> 4. Utwórz i uzupełnij plik `.env`:
> - `cp .env_example .env`
> - `vim .env`
> 
> 5. Wykonaj migrację bazy: `python manage.py migrate`
>
> 6. Uzupełnij teblice słownikowe:
> ```
